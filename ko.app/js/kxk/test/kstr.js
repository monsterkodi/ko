...
<span style="color:#00ff00;">green</span>`)
    ...
    {
        compare(kstr.indexOfClosestNonWS('',0),-1)
        compare(kstr.indexOfClosestNonWS('     ',2),-1)
        compare(kstr.indexOfClosestNonWS(null,2),-1)
        compare(kstr.indexOfClosestNonWS(undefined,2),-1)
        compare(kstr.indexOfClosestNonWS('hello  ',0),0)
        compare(kstr.indexOfClosestNonWS('  llo  ',0),2)
        compare(kstr.indexOfClosestNonWS('  llo  ',2),2)
        compare(kstr.indexOfClosestNonWS('  llo  ',3),3)
        compare(kstr.indexOfClosestNonWS('  llo  ',4),4)
        compare(kstr.indexOfClosestNonWS('  llo  ',5),4)
        compare(kstr.indexOfClosestNonWS('  llo  ',6),4)
        compare(kstr.indexOfClosestNonWS('  l  ',0),2)
        compare(kstr.indexOfClosestNonWS('  l  ',-1),2)
        compare(kstr.indexOfClosestNonWS('  l  ',2),2)
        compare(kstr.indexOfClosestNonWS('  l  ',100),2)
        compare(kstr.indexOfClosestNonWS(' 1    6   a  ',0),1)
        compare(kstr.indexOfClosestNonWS(' 1    6   a  ',1),1)
        compare(kstr.indexOfClosestNonWS(' 1    6   a  ',2),1)
        compare(kstr.indexOfClosestNonWS(' 1    6   a  ',3),1)
        compare(kstr.indexOfClosestNonWS(' 1    6   a  ',4),6)
        compare(kstr.indexOfClosestNonWS(' 1    6   a  ',5),6)
        compare(kstr.indexOfClosestNonWS(' 1    6   a  ',6),6)
        compare(kstr.indexOfClosestNonWS(' 1    6   a  ',7),6)
        compare(kstr.indexOfClosestNonWS(' 1    6   a  ',8),10)
        compare(kstr.indexOfClosestNonWS(' 1    6   a  ',9),10)
        compare(kstr.indexOfClosestNonWS(' 1    6   a  ',10),10)
    })
    section("rangeOfClosestChunk", function ()
    {
        compare(kstr.rangeOfClosestChunk('',0),[-1,-1])
        compare(kstr.rangeOfClosestChunk('     ',2),[-1,-1])
        compare(kstr.rangeOfClosestChunk(null,2),[-1,-1])
        compare(kstr.rangeOfClosestChunk(undefined,2),[-1,-1])
        compare(kstr.rangeOfClosestChunk('  word ',-2),[2,5])
        compare(kstr.rangeOfClosestChunk('  word ',0),[2,5])
        compare(kstr.rangeOfClosestChunk('  word ',1),[2,5])
        compare(kstr.rangeOfClosestChunk('  word ',2),[2,5])
        compare(kstr.rangeOfClosestChunk('  word ',5),[2,5])
        compare(kstr.rangeOfClosestChunk('  word ',7),[2,5])
        compare(kstr.rangeOfClosestChunk('  word ',100),[2,5])
        compare(kstr.rangeOfClosestChunk('  hello   word !',0),[2,6])
        compare(kstr.rangeOfClosestChunk('  hello   word !',2),[2,6])
        compare(kstr.rangeOfClosestChunk('  hello   word !',7),[2,6])
        compare(kstr.rangeOfClosestChunk('  hello   word !',8),[10,13])
        compare(kstr.rangeOfClosestChunk('  hello   word !',9),[10,13])
        compare(kstr.rangeOfClosestChunk('  hello   word !',14),[15,15])
        compare(kstr.rangeOfClosestChunk('  hello   word !',15),[15,15])
        compare(kstr.rangeOfClosestChunk('  hello   word !',100),[15,15])
    })
    ...
    {
        compare(kstr.rangeOfClosestWord('',0),[-1,-1])
        compare(kstr.rangeOfClosestWord('     ',2),[-1,-1])
        compare(kstr.rangeOfClosestWord(null,2),[-1,-1])
        compare(kstr.rangeOfClosestWord(undefined,2),[-1,-1])
        compare(kstr.rangeOfClosestWord('  word ',-2),[2,5])
        compare(kstr.rangeOfClosestWord('  word ',0),[2,5])
        compare(kstr.rangeOfClosestWord('  word ',1),[2,5])
        compare(kstr.rangeOfClosestWord('  word ',2),[2,5])
        compare(kstr.rangeOfClosestWord('  word ',5),[2,5])
        compare(kstr.rangeOfClosestWord('  word ',7),[2,5])
        compare(kstr.rangeOfClosestWord('  word ',100),[2,5])
        compare(kstr.rangeOfClosestWord('  hello   word !',0),[2,6])
        compare(kstr.rangeOfClosestWord('  hello   word !',2),[2,6])
        compare(kstr.rangeOfClosestWord('  hello   word !',7),[2,6])
        compare(kstr.rangeOfClosestWord('  hello   word !',8),[10,13])
        compare(kstr.rangeOfClosestWord('  hello   word !',9),[10,13])
        compare(kstr.rangeOfClosestWord('  hello   word !',14),[10,13])
        compare(kstr.rangeOfClosestWord('  hello   word !',15),[10,13])
    })
