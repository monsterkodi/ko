...
toExport["kode"] = function ()
{
    ...
    {
        rgs = ranges("    f: a b ->")
        compare(inc(rgs,7,'a'),'function argument')
        compare(inc(rgs,9,'b'),'function argument')
        compare(inc(rgs,11,'->'),'punct function tail ligature')
    })
    section("args", function ()
    {
        rgs = ranges("    f: a b ○->")
        compare(inc(rgs,7,'a'),'function argument')
        compare(inc(rgs,9,'b'),'function argument')
        compare(inc(rgs,11,'○'),'punct function async')
        compare(inc(rgs,12,'->'),'punct function tail ligature')
    })
