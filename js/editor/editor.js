 ...
 */
var Buffer, Do, Editor, Syntax, _, empty, filelist, kerror, klog, ref, slash, valid,
    extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
    hasProp = {}.hasOwnProperty;

ref = require('kxk'), _ = ref._, empty = ref.empty, filelist = ref.filelist, kerror = ref.kerror, klog = ref.klog, slash = ref.slash, valid = ref.valid;
...
Editor = (function(superClass) {
    ...
    Editor.prototype.setLines = function(lines) {
        ...
        if (koffee_177_8 = process.hrtime.bigint()) {
            this.syntax.setLines(lines);
            console.log('syntax', (function(b){ let f=1000n; for (let u of ['ns','μs','ms','s']) { if (u=='s' || b<f) { return ''+(1000n*b/f)+u; } f*=1000n; }})(process.hrtime.bigint()-koffee_177_8));
        };
        if (koffee_179_8 = process.hrtime.bigint()) {
            Editor.__super__.setLines.call(this, lines);
            console.log('super', (function(b){ let f=1000n; for (let u of ['ns','μs','ms','s']) { if (u=='s' || b<f) { return ''+(1000n*b/f)+u; } f*=1000n; }})(process.hrtime.bigint()-koffee_179_8));
        };
        if (koffee_181_8 = process.hrtime.bigint()) {
            this.emit('linesSet', lines);
            console.log('emit', (function(b){ let f=1000n; for (let u of ['ns','μs','ms','s']) { if (u=='s' || b<f) { return ''+(1000n*b/f)+u; } f*=1000n; }})(process.hrtime.bigint()-koffee_181_8));
        };
    };
...
//# sourceMappingURL=data:application/json;base64,
