    ...
    Command.prototype["changed"] = function (command)
    {
        ...
        if (items.length)
        {
            if (command.length)
            {
                ...
                items = (function () { var _94__42_ = []; var list = _k_.list(_.sortBy(fuzzied,function (o)
                {
                    return o.index
                })); for (var _94_42_ = 0; _94_42_ < list.length; _94_42_++)  { f = list[_94_42_];_94__42_.push(f.original)  } return _94__42_ }).bind(this)()
            }
