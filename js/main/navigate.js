...
Navigate = (function() {
    ...
    Navigate.prototype.addToHistory = function(file, pos) {
        ...
        results = [];
        while (this.filePositions.length > prefs.get('navigateHistoryLength', 10)) {
