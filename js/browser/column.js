...
Column = (function ()
{
    ...
    {
        var dir, item, updir, _68_98_, _96_47_, _97_74_
    ...
    {
        var onSpringLoadTimeout, pos, row, rowClone, _197_27_
        ...
        if (this.dragStartRow && !this.dragDiv && !_k_.empty(this.browser.select.files()))
        {
            ...
            for (var _176_20_ = 0; _176_20_ < list.length; _176_20_++)
            {
                row = list[_176_20_]
    ...
    {
        var action, column, files, row, target, _215_19_, _224_33_, _226_38_, _260_28_
    ...
    Column.prototype["setItems"] = function (items, opt)
    {
        ...
        var list = _k_.list(this.items)
        for (var _322_17_ = 0; _322_17_ < list.length; _322_17_++)
        {
            item = list[_322_17_]
            this.rows.push(new Row(this,item))
        }
    ...
    {
        var _369_31_, _369_40_

        return ((_369_40_=(this.activeRow() != null ? this.activeRow().path() : undefined)) != null ? _369_40_ : this.parent.file)
    }
    ...
    {
        var _382_20_, _382_27_

        return ((_382_27_=(this.parent != null ? this.parent.file : undefined)) != null ? _382_27_ : '')
    }
    ...
    Column.prototype["numRows"] = function ()
    {
        ...
        return ((_384_32_=this.rows.length) != null ? _384_32_ : 0)
    }
    ...
    Column.prototype["rowHeight"] = function ()
    {
        ...
        return ((_385_46_=(this.rows[0] != null ? this.rows[0].div.clientHeight : undefined)) != null ? _385_46_ : 0)
    }
    ...
    {
        var _434_46_, _434_59_

        return ((_434_46_=this.row(event.target)) != null ? typeof (_434_59_=_434_46_.onMouseOver) === "function" ? _434_59_() : undefined : undefined)
    }

    Column.prototype["onMouseOut"] = function (event)
    {
        var _435_46_, _435_58_

        return ((_435_46_=this.row(event.target)) != null ? typeof (_435_58_=_435_46_.onMouseOut) === "function" ? _435_58_() : undefined : undefined)
    }
    ...
    {
        var index, toIndex, _450_28_, _450_38_

        if (!this.numRows())
        {
            return console.error(`no rows in column ${this.index}?`)
        }
        index = ((_450_38_=(this.activeRow() != null ? this.activeRow().index() : undefined)) != null ? _450_38_ : -1)
    ...
    {
        var index, newIndex, _473_28_, _473_38_

        if (!this.numRows())
        {
            return console.error(`no rows in column ${this.index}?`)
        }
        index = ((_473_38_=(this.activeRow() != null ? this.activeRow().index() : undefined)) != null ? _473_38_ : -1)
        if (!(index != null) || Number.isNaN(index))
        {
            console.error(`no index from activeRow? ${index}?`,this.activeRow())
        }
    ...
    {
        var activeIndex, fuzzied, row, rows, _542_35_, _542_45_
        ...
        activeIndex = ((_542_45_=(this.activeRow() != null ? this.activeRow().index() : undefined)) != null ? _542_45_ : 0)
        ...
        for (var _546_17_ = 0; _546_17_ < list.length; _546_17_++)
        {
            rows = list[_546_17_]
    ...
    {
        var nextOrPrev, row, _566_36_

        if (row = this.activeRow())
        {
            nextOrPrev = ((_566_36_=row.next()) != null ? _566_36_ : row.prev())
            this.removeRow(row)
    ...
    {
        var _574_28_, _574_36_, _574_54_

        if (row === this.activeRow())
        {
            if (((_574_28_=this.nextColumn()) != null ? (_574_36_=_574_28_.parent) != null ? _574_36_.file : undefined : undefined) === (row.item != null ? row.item.file : undefined))
            {
    ...
    Column.prototype["sortByName"] = function ()
    {
        ...
        for (var _593_16_ = 0; _593_16_ < list.length; _593_16_++)
        {
            row = list[_593_16_]
    ...
    Column.prototype["sortByType"] = function ()
    {
        ...
        this.table.innerHTML = ''
        var list = _k_.list(this.rows)
        for (var _605_16_ = 0; _605_16_ < list.length; _605_16_++)
        {
            row = list[_605_16_]
            this.table.appendChild(row.div)
        }
    ...
    Column.prototype["moveToTrash"] = function ()
    {
        ...
        var list = _k_.list(this.browser.select.rows)
        for (var _657_16_ = 0; _657_16_ < list.length; _657_16_++)
        {
            row = list[_657_16_]
            if (slash.win())
            {
    ...
    Column.prototype["duplicateFile"] = function ()
    {
        ...
        for (var _692_17_ = 0; _692_17_ < list.length; _692_17_++)
        {
            file = list[_692_17_]
    ...
    Column.prototype["updateGitFiles"] = function (files)
    {
        ...
        var list = _k_.list(this.rows)
        for (var _723_16_ = 0; _723_16_ < list.length; _723_16_++)
        {
            row = list[_723_16_]
    ...
    {
        var action, paths, target, text, _876_23_
    ...
    {
        var char, combo, key, mod, _913_88_
